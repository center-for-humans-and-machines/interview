...
class CustomFormatter(logging.Formatter):
  ...
  format_dict = {
        ...
        logging.CRITICAL: LogColors.BOLD + LogColors.FAIL + format_string + LogColors.ENDC
    }
...
class CustomLogger(logging.Logger):
  ...
  def _log_with_title(self, level, msg, title=None, args=None, exc_info=None, extra=None, stack_info=False):
